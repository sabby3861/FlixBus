...
protocol FBAlertDelegate {
    func alert(buttonClickedIndex:Int, buttonTitle: String, tag: Int)
}

class FBAlertViewController: NSObject {

    class func showAlert(withTitle title: String, message:String, buttons:[String] = ["Ok"], delegate:FBAlertDelegate? = nil, tag: Int = 0){
